<template>
  <div class="articl-share">
    <a href="#" socialshare="" socialshare-provider="twitter" socialshare-text="Reimbursement and Coding in Radiology"
      socialshare-hashtags="reimbursement-and-coding-in-radiology"
      socialshare-url="https://articl.net/resource/reimbursement-and-coding-in-radiology/research-articles-open-access"
      class="sc-btn sc--tiny sc--twitter">
      <span class="sc-icon">
        <svg viewBox="0 0 33 33" width="25" height="25" xmlns="http://www.w3.org/2000/svg"
    ...
    <a href="#" socialshare="" socialshare-provider="facebook"
      socialshare-url="https://articl.net/resource/reimbursement-and-coding-in-radiology/research-articles-open-access"
      class="sc-btn sc--tiny sc--facebook">
      <span class="sc-icon">
        <svg viewBox="0 0 33 33" width="25" height="25" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink">
          <g>
    ...
    <a href="#" socialshare="" socialshare-provider="linkedin" socialshare-text="Reimbursement and Coding in Radiology"
      socialshare-url="https://articl.net/resource/reimbursement-and-coding-in-radiology/research-articles-open-access"
      class="sc-btn sc--tiny" style="background-color:#0077B5">
      <span class="sc-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33 33" width="24" height="24">
          <g>
            <path
...
.sc-btn {
  ...
  box-shadow: inset rgba(0, 0, 0, 0.1) 0px -0.15em 0px,
    inset rgba(255, 255, 255, 0.2) 0px 0.15em 0px,
    rgba(0, 0, 0, 0.3) 0px 0.1em 0.3em;
  text-align: center;
...
.sc-btn:active {
  box-shadow: rgba(255, 255, 255, 0.2) 0 0.1em 0,
    inset rgba(0, 0, 0, 0.3) 0px 0.25em 1em;
}
...
.sc--shine:active {
  box-shadow: rgba(255, 255, 255, 0.2) 0 0.1em 0,
    inset rgba(0, 0, 0, 0.3) 0px 0.25em 1em,
    inset rgba(255, 255, 255, 0.1) 0px 2.5em 0px -1em;
}
